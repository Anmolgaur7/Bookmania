  ...
  return (
    <div className='flex justify-center items-center mt-10' >
      <form className=' container p-10 flex flex-col bg-slate-500 h-[60vh] w-[40vw] justify-center items-center' onSubmit={handlesubmit} >
        ...
        <input type="text" name="email" placeholder='Enter your email address' onChange={(e) => { setemail(e.target.value) }} className=' w-[30rem]  p-1 m-2' value={email} />
        <label className='font-semibold text-xl text-white'>Password</label>
        <input type="password" name="password" placeholder='Enter your Password' onChange={(e) => { setpass(e.target.value) }} className=' w-[30rem] p-1 m-2' value={password} />
        ...
        <button onClick={googlesignup} className=' p-2 rounded-md bg-red-500 flex justify-center items-center gap-1 font-semibold hover:bg-red-400 '> <FaGoogle /> Login with google</button>
        <button onClick={facebooksignup} className=' p-2 rounded-md bg-blue-500 flex justify-center items-center gap-1 font-semibold hover:bg-blue-400 '> <FaFacebook /> Login with Facebook</button>
        </div>
        <ToastContainer />
      </form>
